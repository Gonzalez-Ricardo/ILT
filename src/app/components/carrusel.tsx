...
const carouselImages = [
  {
    src: "/image/8.png",
    alt: "Flota de camiones de logística profesional",
  },
  {
    src: "/image/11.png",
    alt: "Infraestructura de iluminación municipal moderna",
  },
  {
    src: "/image/13.png",
    alt: "Transporte logístico profesional",
  },
  {
    src: "/image/5.png",
    alt: "Gestión de infraestructura y equipamiento",
  },
];
...
export default function Hero({ onContactClick }: ContactClickProps) {
  ...
  return (
    <section className="relative h-[70vh] sm:h-[75vh] lg:h-[85vh] min-h-[700px] sm:min-h-[850px] overflow-hidden bg-slate-950">
          ...
          <div className="max-w-3xl space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 lg:gap-8 pt-2 sm:pt-4">
              <div className="space-y-1">
                <div className="text-2xl sm:text-3xl lg:text-4xl font-light text-[#42b481]">
                  100+
                </div>
